(function () {
     ...
     */
    function mergeProcessingQueue (pe, collection) {
     ...
     * @param {Function} fail
     */
    function triggerWorkerProcess (process, done, fail) {
     ...
     */
    function createJobsCollection (pe, number) {
        var collection = [];
     ...
     * @param {Pe} pe
     */
    function createJobsCollectionAll (pe) {
     ...
     * @param {*} error
     */
    function triggerFailsListeners (pe, error) {
     ...
     */
    function queueWorkerCallback (pe, callback) {
     ...
     * @param {Pe} pe
     */
    function triggerWorkerCallbacks (pe) {
        var callback;
     ...
     * @param {Function} done
     */
    function triggerNextWorker (pe, done) {
        // lock worker
        unlockStack(pe);
        // go to next worker
        teaseWorker(pe, done);
     ...
     */
    function checkStackAvailability (pe) {
        if (pe.$closed) {
     ...
     * @param {Array} params
     */
    function queueStackParams (pe, params) {
     ...
     */
    function queueStackWorker (pe, worker) {
     ...
     * @param {Pe} pe
     */
    function createEventsListeners (pe) {
        return {
            /**
             * @param {Function} callback
             * @returns {Pe}
